...
df1 %>% ggplot(aes(x = age,
           y = tot, color=sex1))+
  geom_point()+
  labs(title = 'age by expense')
```

```{r}
df1 %>% ggplot(aes(x = provider,
           y = tot, color=sex1))+
  geom_point()+
...
df1 %>% ggplot(aes(x = tot,
           y = los, color=sex1))+
  geom_point()+
  labs(title = 'tot by los')
```

```{r, eval=FALSE}
df1 %>% filter(pt_state %in% c("MA", "RI", "CT")) %>% 
ggplot(aes(x = pt_state,
           y = tot))+
  geom_bar()+
  labs(title = 'pysical therapy in MA, CT, RI vs total cost')
```

```{r}
df1 %>%   ggplot(aes(x = preopday,
           y = tot, color=sex1))+
  geom_point()+
  labs(title = 'preoperation length of stay vs total cost')
```
